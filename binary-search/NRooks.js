// You've got an integer n representing a chessboard of size n x n. 
// Return the number of ways you can place n rooks, such that no two rooks attack each other.
